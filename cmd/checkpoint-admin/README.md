...
```shell
go get github.com/cryptomineroftheworld/go-etherpow/cmd/checkpoint-admin
```
...
*CHECKPOINT_HASH is obtained based on this [calculation method](https://github.com/cryptomineroftheworld/go-etherpow/blob/master/params/config.go#L251).*
